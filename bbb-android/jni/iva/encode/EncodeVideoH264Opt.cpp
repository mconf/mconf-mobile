...
/** Estrutura copiada do ffmpeg exatamente como ela é, sem nenhuma modificação.
 */

const AVOption EncodeVideoH264Opt::options[]={
...
{"timecode_frame_start", "GOP timecode frame start number, in non drop frame format", OFFSET(timecode_frame_start), FF_OPT_TYPE_INT64, 0, 0, (float)INT64_MAX, V|E},
...
{"channel_layout", NULL, OFFSET(channel_layout), FF_OPT_TYPE_INT64, DEFAULT, 0, (float)INT64_MAX, A|E|D, "channel_layout"},
{"request_channel_layout", NULL, OFFSET(request_channel_layout), FF_OPT_TYPE_INT64, DEFAULT, 0, (float)INT64_MAX, A|D, "request_channel_layout"},
